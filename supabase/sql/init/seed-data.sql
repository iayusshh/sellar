...
-- ==========================================
INSERT INTO users (id, email, handle, display_name, bio, avatar_url, social_links) VALUES
...
INSERT INTO products (creator_id, title, description, price, is_active, image_url) VALUES
  ('a1000000-0000-0000-0000-000000000001', 'React Mastery Course', 'Complete React 19 course with hooks, suspense, server components. 12+ hours of HD video.', 1499.00, true, '/images/products/react-mastery.png'),
  ('a1000000-0000-0000-0000-000000000001', 'Node.js Backend Blueprint', 'Production-grade Node.js + Express + PostgreSQL API template with auth, testing, and deployment scripts.', 999.00, true, '/images/products/nodejs-blueprint.png'),
  ('a1000000-0000-0000-0000-000000000001', 'SaaS Starter Kit', 'Full-stack SaaS boilerplate — Next.js + Supabase + Stripe + Tailwind. Ship in a weekend.', 2999.00, true, '/images/products/saas-starter.png'),
  ('a1000000-0000-0000-0000-000000000001', 'Developer Productivity Toolkit', 'VS Code configs, shell scripts, Git aliases, and workflow automations I use daily.', 299.00, true, '/images/products/dev-toolkit.png'),
  ('a1000000-0000-0000-0000-000000000001', 'System Design Interview Guide', '50+ system design problems with solutions. Diagrams, trade-offs, and real-world patterns.', 799.00, true, '/images/products/system-design.png');
...
INSERT INTO products (creator_id, title, description, price, is_active, image_url) VALUES
  ('a2000000-0000-0000-0000-000000000002', 'Personal Finance Masterclass', 'Complete guide to budgeting, saving, investing, and tax planning for Indian salaried professionals.', 1299.00, true, '/images/products/finance-masterclass.png'),
  ('a2000000-0000-0000-0000-000000000002', 'Mutual Fund Selection Framework', 'My exact framework for picking mutual funds. Includes screener template and comparison spreadsheet.', 499.00, true, '/images/products/mutual-fund.png'),
  ('a2000000-0000-0000-0000-000000000002', 'Tax Saving Playbook 2025', 'Every legal tax-saving strategy explained. Section 80C, 80D, HRA, NPS — with calculation sheets.', 699.00, true, '/images/products/tax-playbook.png'),
  ('a2000000-0000-0000-0000-000000000002', 'Monthly Budget Tracker (Notion)', 'Notion template for monthly expense tracking, savings goals, and net-worth dashboard.', 199.00, true, '/images/products/budget-tracker.png'),
  ('a2000000-0000-0000-0000-000000000002', 'Retirement Planning Calculator', 'Excel-based retirement corpus calculator with inflation adjustment and SIP projections.', 349.00, true, '/images/products/retirement-calc.png');
...
INSERT INTO products (creator_id, title, description, price, is_active, image_url) VALUES
  ('a3000000-0000-0000-0000-000000000003', 'Startup Legal Kit', 'Essential legal documents for startups — co-founder agreement, NDA, terms of service, privacy policy.', 2499.00, true, '/images/products/startup-legal.png'),
  ('a3000000-0000-0000-0000-000000000003', 'Freelancer Contract Pack', '5 ready-to-use contract templates for freelancers. Covers scope, payment, IP, and dispute resolution.', 999.00, true, '/images/products/freelancer-contract.png'),
  ('a3000000-0000-0000-0000-000000000003', 'Tenant Rights Guide', 'Know your rights as a tenant in India. Covers rent agreements, security deposits, and eviction laws.', 399.00, true, '/images/products/tenant-rights.png'),
  ('a3000000-0000-0000-0000-000000000003', 'GST Compliance Handbook', 'Step-by-step GST registration, filing, and compliance guide for small businesses.', 599.00, true, '/images/products/gst-handbook.png');
...
INSERT INTO products (creator_id, title, description, price, is_active, image_url) VALUES
  ('a4000000-0000-0000-0000-000000000004', '12-Week Cricket Fitness Program', 'Periodized training plan for cricketers — strength, agility, endurance. Video demos included.', 1799.00, true, '/images/products/cricket-fitness.png'),
  ('a4000000-0000-0000-0000-000000000004', 'Sports Nutrition Blueprint', 'Meal plans, macro calculations, and supplement guide for Indian athletes on a budget.', 599.00, true, '/images/products/sports-nutrition.png'),
  ('a4000000-0000-0000-0000-000000000004', 'Mental Toughness Playbook', 'Psychology techniques used by elite athletes. Visualization, pre-game routines, pressure management.', 499.00, true, '/images/products/mental-toughness.png'),
  ('a4000000-0000-0000-0000-000000000004', 'Injury Prevention & Recovery Guide', 'Common sports injuries, prevention exercises, and rehab protocols. Based on sports science research.', 399.00, true, '/images/products/injury-prevention.png'),
  ('a4000000-0000-0000-0000-000000000004', 'Cricket Batting Masterclass', '3-hour video course breaking down batting technique, shot selection, and match situations.', 899.00, true, '/images/products/batting-masterclass.png');
...
INSERT INTO products (creator_id, title, description, price, is_active, image_url) VALUES
  ('a5000000-0000-0000-0000-000000000005', 'Stock Market Complete Course', 'From candlesticks to company valuation. 20+ hours covering technical and fundamental analysis.', 3499.00, true, '/images/products/stock-course.png'),
  ('a5000000-0000-0000-0000-000000000005', 'Options Trading Playbook', 'Strategies for Nifty/Bank Nifty options — iron condors, straddles, spreads with real trade examples.', 1999.00, true, '/images/products/options-trading.png'),
  ('a5000000-0000-0000-0000-000000000005', 'Stock Screener Template', 'My personal Google Sheets screener with 15+ filters — PE, ROE, debt ratio, promoter holding, and more.', 499.00, true, '/images/products/stock-screener.png'),
  ('a5000000-0000-0000-0000-000000000005', 'IPO Analysis Framework', 'How to evaluate IPOs before applying. Checklist, red flags, and valuation methods.', 349.00, true, '/images/products/ipo-framework.png'),
  ('a5000000-0000-0000-0000-000000000005', 'Trading Journal + Risk Calculator', 'Notion + Sheets combo for tracking trades, win rate, R:R ratio, and monthly P&L.', 299.00, true, '/images/products/trading-journal.png');
